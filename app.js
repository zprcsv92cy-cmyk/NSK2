  ...
  async function renderLineupSelectors() {
    ...
    try {
      ...
      if (players.length === 0 && coaches.length === 0) {
        setText("lineupMsg", "Inga spelare eller tränare hittades i truppen.");
      } else if (players.length === 0) {
        setText("lineupMsg", "Inga spelare hittades i truppen.");
      } else if (coaches.length === 0) {
        setText("lineupMsg", "Inga tränare hittades i truppen.");
      } else {
        setText("lineupMsg", "");
      }
    } catch (err) {
